...
pub mod api_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn create_entity(
            &mut self,
            request: impl tonic::IntoRequest<super::CreateEntityReq>,
        ) -> std::result::Result<
            tonic::Response<super::CreateEntityResp>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/proto.ApiService/CreateEntity",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("proto.ApiService", "CreateEntity"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_entity(
            &mut self,
            request: impl tonic::IntoRequest<super::GetEntityReq>,
...
pub mod api_service_server {
    ...
    pub trait ApiService: std::marker::Send + std::marker::Sync + 'static {
        async fn create_entity(
            &self,
            request: tonic::Request<super::CreateEntityReq>,
        ) -> std::result::Result<
            tonic::Response<super::CreateEntityResp>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/proto.ApiService/CreateEntity" => {
                    ...
                    struct CreateEntitySvc<T: ApiService>(pub Arc<T>);
                    impl<
                        T: ApiService,
                    > tonic::server::UnaryService<super::CreateEntityReq>
                    for CreateEntitySvc<T> {
                        type Response = super::CreateEntityResp;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as ApiService>::create_entity(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
