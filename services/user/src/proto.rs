...
pub mod api_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn create_user(
            ...
            let path = http::uri::PathAndQuery::from_static("/proto.ApiService/CreateUser");
        ...
        pub async fn get_user(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("proto.ApiService", "GetUser"));
            self.inner.unary(req, path, codec).await
        }
        ...
        ) -> std::result::Result<tonic::Response<super::GetUserIdFromGoogleIdResp>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/proto.ApiService/GetUserIdFromGoogleId");
            let mut req = request.into_request();
            req.extensions_mut()
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/proto.ApiService/CreateUser" => {
                    ...
                    impl<T: ApiService> tonic::server::UnaryService<super::CreateUserReq> for CreateUserSvc<T> {
                ...
                "/proto.ApiService/GetUser" => {
                    ...
                    impl<T: ApiService> tonic::server::UnaryService<super::GetUserReq> for GetUserSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut =
                                async move { <T as ApiService>::get_user(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                    let accept_compression_encodings = self.accept_compression_encodings;
                ...
                "/proto.ApiService/GetUserIdFromGoogleId" => {
                    ...
                    impl<T: ApiService> tonic::server::UnaryService<super::GetUserIdFromGoogleIdReq>
                        for GetUserIdFromGoogleIdSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ApiService>::get_user_id_from_google_id(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
